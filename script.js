...
demoButton.addEventListener('click', () => {
  if (demoButton.innerHTML === 'Register') {
    if (isMobile()) {
      leftDiv.style.transform = 'translateY(60%)'; 
      rightDiv.style.transform = 'translateY(-40%)';
    } else {
    ...
    text.innerHTML = 'Already have an account? Click here to login!';
    ...
    text.innerHTML = "Don't have an account? To create a new account click here!";
